...
@objc public class JLToastCenter: NSObject {
    ...
    override init() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: Selector(self.deviceOrientationDidChange(nil)), name: UIDeviceOrientationDidChangeNotification, object: nil)
    }
